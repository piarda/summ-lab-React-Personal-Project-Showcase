...
// Mock functions to track calls to useNavigate and setProducts
...
// Mock data to be returned by the useFetchProducts hook
const mockWines = [
  {
    id: 1,
    name: 'Red Wine',
...
describe('ProductPage', () => {
  global.fetch = vi.fn();
  // Mock the global fetch function to prevent real API calls during tests
  ...
  test('edit button navigates to the edit product page', () => {
    ...
    // Assert mock navigate function was called with the correct path
